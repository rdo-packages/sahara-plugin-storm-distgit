...
%global pname sahara-plugin-storm
%global module sahara_plugin_storm
...
Name:          python-sahara-plugin-storm
Version:       XXX
Release:       XXX
...
Summary:          Storm plugin for Sahara
...
Summary:        Tests of the Storm plugin for Sahara
...
This package contains the test files of the Storm plugin for Sahara.
...
Group:         Documentation
Summary:       Usage documentation for the Storm plugin for Sahara
Requires:      python3-%{pname} = %{version}-%{release}
...
This documentation provides details about the Storm plugin for Sahara.
...
%changelog
# REMOVEME: error caused by commit http://git.openstack.org/cgit/openstack/sahara-plugin-storm/commit/?id=d9c7835e45a1df9ac3be8b8d0da5937c00da665f
